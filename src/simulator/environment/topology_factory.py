    ...
    def generate_positions(self, **kwargs) -> List[CartesianCoordinate]:
        ...
        for i in range(num_clusters):
            ...
            for _ in range(nodes_per_cluster - 1):
                ...
                node_dist = node_radius * math.sqrt(rng.uniform(0.0, 1.0))  # distribute nodes uniformly within the cluster area
...
class TopologyFactory:
    ...
    def __init__(self):
        self._strategies: Dict[str, TopologyStrategy] = {} # can register new strategies at runtime
