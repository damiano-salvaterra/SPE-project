...
class Frame_802154(Packet):
    ...
    def __init__(self, saddr: bytes, daddr: bytes, requires_ack: bool = False, data: Optional[Any] = None):
        self.saddr = saddr # source address
        self._daddr = daddr # destination address
...
class Ack_802154(Packet):
    ...
    def __init__(self, saddr: bytes, daddr: bytes):
        self.saddr = saddr # source address
        self._daddr = daddr # destination address
