...
class SimplePhyLayer(Layer, Entity):
    ...
    def _finalize_rx(self):
        ...
        if is_decoded:
            ...
            self._last_successful_rx_rssi_dBm = (
                10 * log10(power_W * 1000) if power_W > 0 else -150
            )
    ...
    def _schedule_sync_check(self, transmission: "Transmission"):
        ...
        if isinstance(transmission.packet, Ack_802154):
            ...
            is_for_me = (
                ...
                or transmission.packet.rx_addr == Frame_802154.broadcast_linkaddr
            )
            detection_time = (
                self.host.context.scheduler.now()
    ...
    def send(self, payload: MACFrame):
        ...
        tx_start_event = PhyTxStartEvent(
            start_time, self, self.on_PhyTxStartEvent, transmission=transmission
        )
        tx_end_event = PhyTxEndEvent(
            end_time, self, self.on_PhyTxEndEvent, transmission=transmission
        )
